 ...
 */
@AndroidEntryPoint
internal class TodayAppWidgetProvider : BaseWidgetProvider<TodayWidgetState>() {
    ...
    override fun updateAppWidget(
        ...
        views.setOnClickPendingIntent(WidgetsR.id.widget_root, state?.launchIntent?.clickIntent(context))
